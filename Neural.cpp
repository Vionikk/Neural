...
long double average(long double a, long double b, long double c, long double d, long double e){
    long double t = 5.0;
    return (a+b+c+d+e)/t;
}
int main() {
    long double t_in1[3] = { 1, 0, 0 }, t_out1 = 1, w1 = -0.37543/*Випадкові ваги*/, out1;
    long double t_in2[3] = { 1, 1, 0 }, t_out2 = 1, w2 = -0.37543/*Випадкові ваги*/, out2;
    long double t_in3[3] = { 1, 1, 1 }, t_out3 = 1, w3 = -0.37543/*Випадкові ваги*/, out3;
    long double t_in4[3] = { 1, 1, 1 }, t_out4 = 1, w4 = -0.37543/*Випадкові ваги*/, out4;
    ...
    long double avearge = average(out1, out2, out3, out4, out5);
